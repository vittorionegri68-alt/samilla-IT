        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 48, marginBottom: 48 }}>
          ...
          <div>
            ...
            <a href={contactInfo.instagram} target="_blank" rel="noopener noreferrer" style={{
              fontSize: '0.8rem', color: '#a0782a', fontWeight: 500,
            }}>📸 Instagram</a>
          </div>
          ...
          <div>
            ...
            <a href={config.airbnbUrl} target="_blank" rel="noopener noreferrer" style={{
              ...
              padding: '12px 24px', borderRadius: 4, fontSize: '0.875rem', fontWeight: 500,
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.1)', padding: '20px 24px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 20, alignItems: 'center' }}>
            ...
            >{t.footer.privacy}</a>
            <span style={{ fontSize: '0.78rem', color: 'rgba(255,255,255,0.45)' }}>
              <span style={{ color: '#a0782a', fontWeight: 600 }}>IT</span>
              {' | '}
              <a href={config.langEN} style={{ color: 'rgba(255,255,255,0.45)', transition: 'color 0.2s' }}
                onMouseEnter={e => e.currentTarget.style.color = '#ffffff'}
                onMouseLeave={e => e.currentTarget.style.color = 'rgba(255,255,255,0.45)'}
              >EN</a>
            </span>
