      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 28 }} className="desktop-nav">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginLeft: 4 }}>
            <span style={{ fontWeight: 600, fontSize: '0.8rem', color: '#a0782a' }}>IT</span>
            <span style={{ color: scrolled ? '#ccc' : 'rgba(255,255,255,0.4)', fontSize: '0.75rem' }}>|</span>
            <a href={config.langEN} style={{ fontWeight: 400, fontSize: '0.8rem', color: linkColor, transition: 'color 0.3s' }}>EN</a>
          </div>
        </div>
      ...
      {menuOpen && (
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <span style={{ fontWeight: 600, fontSize: '0.85rem', color: '#a0782a' }}>IT</span>
            <span style={{ color: '#ccc' }}>|</span>
            <a href={config.langEN} style={{ fontWeight: 400, fontSize: '0.85rem', color: '#9a8f84' }}>EN</a>
          </div>
        </div>
      )}
