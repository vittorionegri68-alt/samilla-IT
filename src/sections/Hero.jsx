...
// Immagini struttura da Airbnb CDN
    ...
    <section ref={ref} style={{ minHeight: '100vh', display: 'grid', gridTemplateColumns: '1fr 1fr' }} className="split-grid">
        ...
        <div className="reveal" style={{ transitionDelay: '0.1s' }}>
          ...
          <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap', marginBottom: 48 }}>
            <a href={config.airbnbUrl} target="_blank" rel="noopener noreferrer" style={{
              ...
              borderRadius: 4, fontWeight: 500, fontSize: '0.95rem',
            ...
            <a href="#apartment" style={{
              ...
              borderRadius: 4, fontWeight: 400, fontSize: '0.95rem',
              transition: 'all 0.2s',
            }}
      ...
      <div style={{ position: 'relative', minHeight: '100vh', overflow: 'hidden' }} className="reveal">
        ...
        <div style={{
          ...
          <img src={IMG_HERO2} alt="Samilla Loft interno" style={{ width: 52, height: 52, borderRadius: 6, objectFit: 'cover' }} />
          <div>
            <div style={{ fontWeight: 600, fontSize: '0.85rem', color: '#1a1612' }}>Vista mare inclusa</div>
            <div style={{ fontSize: '0.75rem', color: '#9a8f84', marginTop: 2 }}>Adriatico a 2 minuti</div>
          </div>
        </div>
      </div>
